...
public class AsyncTaskMove extends AsyncTask<String, String, String> {
    private String move, answerHTTP;
    Context context;


    public AsyncTaskMove(Context context, String move) {
        this.move = move;
        this.context = context;
    }

    String server = "http://jws-app-chess.7e14.starter-us-west-2.openshiftapps.com/api/move";
